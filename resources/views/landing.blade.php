...
<body x-data="{
    ...
    <header
        class="bg-brand-yellow hero-pattern dark:bg-bg-deep dark:bg-none px-6 lg:px-12 py-12 rounded-b-[3rem] relative overflow-hidden border-b border-gray-100 dark:border-white/5 min-h-screen flex flex-col">
        <!-- Navigation -->
        <nav class="w-full max-w-7xl mx-auto flex items-center justify-between z-20 mb-12">
            <div class="flex items-center gap-3">
                <div class="bg-slate-900 dark:bg-brand-yellow rounded-xl shadow-md">
                    <span
                        class="material-symbols-outlined text-brand-yellow dark:text-bg-deep p-2.5 text-4xl">airport_shuttle</span>
                </div>
        ...
        <!-- Hero Content -->
        <div class="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-18 items-start flex-grow relative z-10">
            <div class="space-y-8 text-center lg:text-left">
                <h1
                    class="text-4xl md:text-5xl xl:text-6xl font-black leading-[1.1] text-slate-900 dark:text-brand-yellow">
                    Encontre transporte escolar que realmente atende sua escola e sua região.
                </h1>
                <p
                    class="text-xl text-slate-800 dark:text-light-grey max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 pt-4">
                    ...
                    <a class="bg-brand-green hover:bg-brand-green/90 text-white text-lg font-bold py-5 px-8 rounded-2xl flex items-center justify-center gap-3 shadow-xl transition-all hover:-translate-y-1 dark:bg-transparent dark:border-2 dark:border-brand-green dark:text-brand-green hover:dark:text-white"
                        href="#transportadores" x-on:click.prevent="scrollTo('transportadores')">
            ...
            <div class="relative hidden lg:block">
                <div
                    class="bg-white/30 dark:bg-white/5 backdrop-blur-sm rounded-[3rem] p-4 border-4 border-white/50 dark:border-white/10 overflow-hidden shadow-2xl">
                    <img alt="Mapa de Curitiba"
                        class="w-full h-[450px] object-cover rounded-[2.5rem] grayscale invert dark:invert-0 brightness-95 contrast-110"
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuCfv0r8wZCq_pZGDwotxYwoQAYsjLzbHb9MS4N0mtmtPmzl3Tfq47EChkW3vCDXFbt3BDG4C21h4jYLFyUZt3HBu3uRSyTd2jA50RiKfBQPowLL8ckAmNrYuA3Bqz96GebeXb2Ke87gkne20ibBwUpk9TpkY0iBXHQOtyoPp0gsSJG7Lkn35bwsySKYYmV61jPAn1-1GOvC1oN7J7h21G_E-uKtM3od3361v_KsVsA7WAV_3NPw1LnxiWXGUwiiPmLElERWyfMArMro" />
                </div>

                <!-- Badge -->
                <div
                    class="absolute -bottom-6 -left-2 bg-white dark:bg-bg-section-1 p-6 rounded-2xl shadow-xl flex items-center gap-4 border border-gray-100 dark:border-white/5">
                    <div class="bg-brand-yellow rounded-full">
                        <span class="material-symbols-outlined text-slate-900 p-3">verified</span>
                    </div>
                    <div>
                        <p class="font-bold text-slate-900 dark:text-off-white">100% Curitiba e Região</p>
    ...
    <section class="px-6 py-24 bg-off-white dark:bg-bg-section-1 min-h-screen flex items-center" id="responsaveis">
        <div class="max-w-7xl mx-auto w-full">
            <div
                class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-100 dark:bg-blue-100/10 text-primary text-sm font-bold uppercase tracking-wider mb-6">
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                ...
                <div class="space-y-8">
                    <h2
                        class="text-3xl lg:text-4xl font-extrabold flex items-center gap-3 text-gray-900 dark:text-off-white">
                        <span class="material-symbols-outlined text-brand-yellow text-5xl">search</span>
                        Procurando transporte escolar?
                    </h2>
                    <p class="text-xl text-gray-600 dark:text-light-grey font-medium leading-relaxed max-w-xl">
                        Encontre os melhores transportadores que atendem especificamente a escola dos seus filhos e a
                        sua região.
                    </p>
                    <ul class="grid sm:grid-cols-2 gap-4 lg:gap-6">
                        <li
                            class="flex items-center gap-3 bg-white dark:bg-bg-deep p-4 rounded-xl shadow-sm border border-gray-100 dark:border-white/5">
                            <span
                                class="material-symbols-outlined text-brand-yellow bg-brand-yellow/10 p-1.5 rounded-full text-sm">check</span>
                ...
                <!-- Form Column -->
                <div
                    class="bg-white dark:bg-bg-deep p-8 lg:p-10 rounded-[2.5rem] border border-gray-200 dark:border-white/10 shadow-2xl relative">
                    <div
                        class="absolute -top-4 -right-4 bg-brand-yellow text-bg-deep px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest shadow-lg">
                        Rápido e Direto
                    </div>
                    <h3 class="text-2xl font-bold mb-6 text-gray-900 dark:text-off-white">Interessado? Deixe seu contato
                    </h3>
    ...
    <section class="px-6 py-24 bg-white dark:bg-bg-section-2 min-h-screen flex items-center" id="transportadores">
        <div class="max-w-7xl mx-auto w-full">
            <div
                class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-green-50 dark:bg-brand-green/10 text-brand-green text-sm font-bold uppercase tracking-wider mb-6">
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                ...
                <div class="space-y-8 lg:order-1">
                    ...
                    <p class="text-xl text-gray-600 dark:text-light-grey font-medium leading-relaxed max-w-xl">
                        Otimize sua rota e aumente seu faturamento recebendo interessados que já estão no seu trajeto
                        diário.
                    </p>
                    <div class="grid grid-cols-2 gap-4">
                        <div
                            class="bg-off-white dark:bg-bg-section-1 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5">
                ...
                <!-- Form Column -->
                <div
                    class="bg-off-white dark:bg-bg-deep p-8 lg:p-10 rounded-[2.5rem] shadow-2xl border border-gray-200 dark:border-white/10 relative lg:order-2">
                    <div
                        class="absolute -top-4 -left-4 bg-brand-green text-white px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest shadow-lg">
                        Exclusivo Curitiba e Região
                    </div>
                    <h3 class="text-2xl font-bold mb-6 text-gray-900 dark:text-off-white">Cadastro de Transportador
                    </h3>
                    <form class="space-y-5">
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                <label
                                    class="block text-sm font-semibold mb-2 text-gray-600 dark:text-light-grey">Cidade</label>
                                <input
                                    class="w-full p-4 rounded-xl border-gray-200 dark:border-white/20 bg-white dark:bg-bg-section-1 text-gray-900 dark:text-off-white focus:ring-brand-yellow focus:border-brand-yellow"
                                    placeholder="Curitiba ou região" type="text">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-2 text-gray-600 dark:text-light-grey">Nº
                                    Veículos</label>
                                <input
                                    class="w-full p-4 rounded-xl border-gray-200 dark:border-white/20 bg-white dark:bg-bg-section-1 text-gray-900 dark:text-off-white focus:ring-brand-yellow focus:border-brand-yellow"
    ...
    <footer class="px-6 py-12 bg-bg-deep/90 dark:bg-bg-deep border-t border-slate-800 dark:border-white/10">
        <div class="max-w-md mx-auto text-center">
            <div class="grid grid-cols-3 gap-4 mb-12">
                <div class="flex flex-col items-center">
                    ...
                    <span
                        class="text-[10px] font-bold uppercase tracking-wider text-brand-yellow dark:text-light-grey">Foco
                        em Curitiba e Região</span>
                </div>
                <div class="flex flex-col items-center">
                    <div class="w-12 h-12 bg-brand-yellow/10 rounded-full flex items-center justify-center mb-2">
                    ...
                    <span
                        class="text-[10px] font-bold uppercase tracking-wider text-brand-yellow dark:text-light-grey">Plataforma
                        Independente</span>
                </div>
                <div class="flex flex-col items-center">
                    <div class="w-12 h-12 bg-brand-yellow/10 rounded-full flex items-center justify-center mb-2">
                    ...
                    <span
                        class="text-[10px] font-bold uppercase tracking-wider text-brand-yellow dark:text-light-grey">Contato
                        Direto</span>
                </div>
            </div>
            <div class="mb-8">
                <div class="flex items-center justify-center gap-2 mb-4 opacity-80">
                    <div class="bg-brand-yellow rounded-sm">
                        <span class="material-symbols-outlined text-bg-deep p-1.5 text-lg">airport_shuttle</span>
                    </div>
            ...
            <div
                class="h-32 w-full rounded-xl bg-slate-800 dark:bg-bg-section-1 overflow-hidden relative border border-slate-700 dark:border-white/10">
                <img alt="Mapa de Curitiba e região metropolitana"
                    class="w-full h-full object-cover opacity-20 grayscale invert dark:invert-0"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCfv0r8wZCq_pZGDwotxYwoQAYsjLzbHb9MS4N0mtmtPmzl3Tfq47EChkW3vCDXFbt3BDG4C21h4jYLFyUZt3HBu3uRSyTd2jA50RiKfBQPowLL8ckAmNrYuA3Bqz96GebeXb2Ke87gkne20ibBwUpk9TpkY0iBXHQOtyoPp0gsSJG7Lkn35bwsySKYYmV61jPAn1-1GOvC1oN7J7h21G_E-uKtM3od3361v_KsVsA7WAV_3NPw1LnxiWXGUwiiPmLElERWyfMArMro">
                <div class="absolute inset-0 flex items-center justify-center">
                    <span
                        class="bg-slate-900/80 dark:bg-bg-deep/80 text-brand-yellow px-3 py-1 rounded-full text-xs font-bold border border-slate-700 dark:border-white/10">Curitiba
                        & Região</span>
                </div>
            </div>
        </div>
    ...
    <button x-show="showScrollTop" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 translate-y-10 scale-90"
        x-transition:enter-end="opacity-100 translate-y-0 scale-100"
        x-transition:leave="transition ease-in duration-300"
        x-transition:leave-start="opacity-100 translate-y-0 scale-100"
        x-transition:leave-end="opacity-0 translate-y-10 scale-90" x-on:click="scrollTo('top')"
        class="fixed bottom-8 right-8 z-50 bg-brand-yellow text-bg-deep p-4 rounded-2xl shadow-2xl hover:scale-110 active:scale-95 transition-all flex items-center justify-center border-2 border-slate-900/10 dark:border-white/10 group cursor-pointer"
        aria-label="Voltar para o topo">
        <span
            class="material-symbols-outlined font-bold group-hover:-translate-y-1 transition-transform">arrow_upward</span>
    </button>
</body>
